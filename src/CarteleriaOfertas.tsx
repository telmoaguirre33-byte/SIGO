...
export default function CarteleriaOfertas({ productos }: Props) {
  ...
  function imprimir(){
    ...
    ventana.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>SIGO · Ofertas</title><style>
      ...
      .cartel.horizontal{grid-template-columns:minmax(52%,1.15fr) minmax(0,.95fr);grid-template-rows:auto auto auto;column-gap:5mm;row-gap:1mm;align-content:center;padding:2.5mm 5mm}
      ...
      .horizontal .precio{grid-column:2;grid-row:3;align-self:start;width:100%;font-size:${formato==="a4_4"?"46px":"64px"};padding:4mm 5mm;border-radius:5mm;background:#e10600;color:#fff200;text-shadow:1px 1px 0 #991b1b}
