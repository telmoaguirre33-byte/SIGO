...
const checks = [
  ['src/ComprasOperativas.tsx', ['Leer comprobante de compra con IA', 'Tomar foto de factura', 'application/pdf', 'capture="environment"', 'REVISADO · PREPARAR COMPRA', 'guardarProductoSigo', 'analizarFacturaCompraSigo', 'Confirmar compra e ingresar stock', 'preciosVentaFactura', 'preciosFacturaPendientes', 'NUEVO · requiere precio', 'SIGO no los creará sin precio']],
