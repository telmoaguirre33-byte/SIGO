...
const clientRequired = [
  ...
  ['CRÍTICO · Revisar', 'critical line mismatch user-facing warning'],
  ...
  ['permite vincular explícitamente esta línea al producto existente', 'existing product identity review path'],
