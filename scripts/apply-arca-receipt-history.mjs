...
// Estado persistente de comprobantes emitidos + buscador de ventas/tickets.
...
// Antes se filtraban las ventas facturadas. Ese filtro provocaba que una compra recién
// hecha desapareciera del selector y dejara visible un comprobante viejo.
...
// Recuperar exactamente el comprobante fiscal de la venta seleccionada. Nunca mostrar
// el comprobante viejo de otra venta y nunca pedir un CAE nuevo para reimprimir.
...
// UX: buscar por número, importe o fecha; marcar claramente qué venta ya tiene factura.
...
// Si la venta elegida ya está facturada, la acción disponible es reimprimir/compartir,
// no volver a emitir. Para una venta pendiente, el texto comercial es "Emitir factura".
...
// Mensaje contextual al seleccionar un comprobante ya emitido.
